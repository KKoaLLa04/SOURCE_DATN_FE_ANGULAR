...
@Component({
  selector: 'app-modal-parent-form-staff',
  templateUrl: './modal-parent-form-staff.component.html',
  styleUrls: ['./modal-parent-form-staff.component.scss'],
  standalone: true,
  imports: [
    TranslocoModule,
    FormsModule,
...
export class ModalParentFormStaffComponent implements OnInit {
  @Input() dataModal: any;
  formGroup: FormGroup;
  dataForm: any
  dataFromParent: any;
  ...
  initForm() {
    this.formGroup = this.fb.group({
      ...
      password: [
        this.dataFromParent.nameForm == 'update'
          ? this.dataFromParent?.data?.password
          : '',
        [Validators.required],
      ],
      confirmPassword: [
        this.dataFromParent.nameForm == 'update'
          ? this.dataFromParent?.data?.confirmPassword
          : '',
      ],
      status: [
        this.dataFromParent.nameForm == 'update'
      ...
      email: [
        this.dataFromParent.nameForm == 'update'
          ? this.dataFromParent?.data?.email
          : '',
        [Validators.required],
      ],
      dob: [
        this.dataFromParent.nameForm == 'update'
          ? this.convertToTimestamp(this.dataFromParent?.data?.dob)
          : '',
        [Validators.required],
      ],
      address: [
