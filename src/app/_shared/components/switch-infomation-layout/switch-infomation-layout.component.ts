...
@Component({
    ...
    standalone: true,
    imports: [NgIf, NzDropdownButtonDirective, NzDropDownDirective, NzDropdownMenuComponent, NzMenuDirective, NzSelectComponent, FormsModule, NgFor, NzOptionComponent, NzMenuItemComponent]
})
