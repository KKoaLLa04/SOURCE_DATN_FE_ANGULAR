...
import { OnlyNumberDirective } from '../../directive/only-number-interger.directive';
...
@Component({
    ...
    standalone: true,
    imports: [TranslocoModule, FormsModule, ReactiveFormsModule, NgFor, FieldErrorDisplayComponent, NgIf, OnlyNumberDirective]
})
