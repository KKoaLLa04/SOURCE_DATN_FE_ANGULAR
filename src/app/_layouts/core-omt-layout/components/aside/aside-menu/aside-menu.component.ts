  ...
  ngOnInit(): void {
    ...
    if(Number(layout) == Number(AccessType.MANAGER)){
      this.menuLayout = [
        ...
        {icon: "assets/images/svg/icon-sidebar/icon-ql-menu-khach-hang.svg", name:"Thời khóa biểu", url:"/staff/timetable", permissionCode : '', code: 'timetable', children: []},
        ...
        {icon: "assets/images/svg/icon-sidebar/icon-ql-menu-khach-hang.svg", name:"Cấu hình", url:"/staff/config", permissionCode : '', code: 'config', children: []},
      ]
